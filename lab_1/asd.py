...
# CIFAR10 dataset
train_dataset = torchvision.datasets.CIFAR10(root='./', train=True, transform=transform, download=False)
...
for epoch in range(EPOCH):
    ...
    for i, (images, labels) in enumerate(train_loader):
        ...
        if (i + 1) % 100 == 0:
            print("Epoch [%d/%d], Iter [%d/%d] Loss: %.4f" % (epoch + 1, EPOCH, i + 1, 100, loss.item()))
